...
extern const GUID SAMPLEIME_GUID_LANG_BAR_DOUBLE_SINGLE_BYTE;

extern const GUID SAMPLEIME_GUID_LANG_BAR_IMEMODE;

extern const GUID SAMPLEIME_GUID_LANG_BAR_PUNCTUATION;
